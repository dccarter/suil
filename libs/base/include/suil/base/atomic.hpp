//
// https://github.com/suilteam/co/blob/master/include/co/unix/atomic.h
//
//

#ifndef LIBS_BASE_INCLUDE_SUIL_BASE_ATOMIC_HPP
#define LIBS_BASE_INCLUDE_SUIL_BASE_ATOMIC_HPP
...
#endif //LIBS_BASE_INCLUDE_SUIL_BASE_ATOMIC_HPP
